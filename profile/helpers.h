...
#define BPF_HASH_OF_MAPS(...)                                                               \
    BPF_HASH_OF_MAPSX(__VA_ARGS__, BPF_HASH_OF_MAPS4, BPF_HASH_OF_MAPS3, BPF_HASH_OF_MAPS2) \
    (__VA_ARGS__)
...
#define BPF_SOCKHASH_COMMON(_name, _key_type, _max_entries)                                                   \
    ...
    __attribute__((section("maps/sockhash"))) struct _name##_table_t _name = {.max_entries = (_max_entries)}; \
...
#define BPF_SOCKHASH(...)                                                   \
    BPF_SOCKHASHX(__VA_ARGS__, BPF_SOCKHASH3, BPF_SOCKHASH2, BPF_SOCKHASH1) \
    (__VA_ARGS__)
